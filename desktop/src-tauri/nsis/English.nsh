...
LangString appRunning ${LANG_ENGLISH} "DeepSeek-Spec is running! Please close it first then try again."
LangString appRunningOkKill ${LANG_ENGLISH} "DeepSeek-Spec is running!$\nClick OK to kill it"
...
LangString failedToKillApp ${LANG_ENGLISH} "Failed to kill DeepSeek-Spec. Please close it first then try again"
