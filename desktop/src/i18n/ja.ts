export const ja = {
  ...
  toast: {
    ...
    cleared: "UIをクリアしました",
    aboutLine: "DeepSeek-Spec v{version} · キャッシュファーストDeepSeekエージェント",
  },
  composer: {
    busy: "dspecが考え中…",
    idle: "質問する",
  ...
  settings: {
    ...
    editorDefault: "(デフォルト)",
    apiKey: "APIキー",
    apiKeyHint: "DeepSeekキー — ~/.dspec/config.json (0600) に保存。",
    apiKeyNotSet: "(未設定)",
    apiKeyCancel: "キャンセル",
    apiKeySave: "保存",
    apiKeyShow: "表示",
    ...
    mcpBridged: "· ブリッジ済み",
    mcpNotBridged:
      "· 現在のデスクトップセッションはブリッジされていません — dspec code (TUI) を再起動すると有効になります",
    ...
    skillsEmpty:
      "利用可能なスキルがありません。~/.dspec/skills/ またはプロジェクトルートの .dspec/skills/ に SKILL.md を作成してください。",
  ...
  app: {
    ...
    connecting: "dspecコアに接続中…",
    startupFailedTitle: "DeepSeek-Specを起動できませんでした",
  ...
  notifications: {
    approvalTitle: "DeepSeek-Specが承認待ちです",
    inputTitle: "DeepSeek-Specが入力を待っています",
    planApprovalTitle: "DeepSeek-Specがプラン承認待ちです",
    checkpointApprovalTitle: "DeepSeek-Specがチェックポイント承認待ちです",
    revisionTitle: "DeepSeek-Specがプラン修正を提案しました",
    commandBody: "コマンド: {command}",
    readBody: "読み取り: {path}",
    writeBody: "書き込み: {path}",
    turnCompleteTitle: "DeepSeek-Specタスク完了",
