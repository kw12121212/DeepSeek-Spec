...
export const de: typeof en = {
  ...
  toast: {
    ...
    cleared: "UI geleert",
    aboutLine: "DeepSeek-Spec v{version} · Cache-First-DeepSeek-Agent",
  },
  composer: {
    ...en.composer,
    busy: "dspec denkt nach...",
    idle: "Frag etwas",
    send: "senden",
    newline: "neue Zeile",
    commands: "Befehle",
  ...
  settings: {
    ...
    apiKeyHint: "DeepSeek-Schlüssel — gespeichert in ~/.dspec/config.json (0600).",
    ...
    mcpNotBridged:
      "· Aktuelle Desktop-Sitzung nicht verbunden — starte dspec code (TUI) neu, um wirksam zu werden",
    ...
    skillsEmpty:
      "Keine Skills verfügbar. Erstelle SKILL.md unter ~/.dspec/skills/ oder .dspec/skills/ in deinem Projekt-Root.",
  ...
  app: {
    ...
    connecting: "Verbinde mit dspec core...",
    startupFailedTitle: "DeepSeek-Spec konnte nicht starten",
  ...
  notifications: {
    ...en.notifications,
    approvalTitle: "DeepSeek-Spec wartet auf Genehmigung",
    inputTitle: "DeepSeek-Spec wartet auf Eingabe",
    planApprovalTitle: "DeepSeek-Spec wartet auf Plan-Genehmigung",
    checkpointApprovalTitle: "DeepSeek-Spec wartet auf Checkpoint-Genehmigung",
    revisionTitle: "DeepSeek-Spec hat eine Plan-Überarbeitung vorgeschlagen",
    commandBody: "Befehl: {command}",
    readBody: "Lesen: {path}",
    writeBody: "Schreiben: {path}",
    turnCompleteTitle: "DeepSeek-Spec-Aufgabe abgeschlossen",
