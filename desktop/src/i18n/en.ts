export const en = {
  ...
  settings: {
    ...
    apiKey: "API key",
    apiKeyHint: "DeepSeek key — saved to ~/.dspec/config.json (0600).",
    ...
    mcpBridged: "· Bridged",
    mcpNotBridged:
      "· Current desktop session not bridged — restart dspec code (TUI) to take effect",
    ...
    skillsEmpty:
      "No skills available. Create SKILL.md under ~/.dspec/skills/ or .dspec/skills/ in your project root.",
  ...
  app: {
    ...
    connecting: "Connecting to dspec core…",
    startupFailedTitle: "DeepSeek-Spec could not start",
  ...
  notifications: {
    approvalTitle: "DeepSeek-Spec is waiting for approval",
    inputTitle: "DeepSeek-Spec is waiting for input",
    planApprovalTitle: "DeepSeek-Spec is waiting for plan approval",
    checkpointApprovalTitle: "DeepSeek-Spec is waiting for checkpoint approval",
    revisionTitle: "DeepSeek-Spec proposed a plan revision",
    commandBody: "Command: {command}",
    readBody: "Read: {path}",
    writeBody: "Write: {path}",
    turnCompleteTitle: "DeepSeek-Spec task complete",
