/** Render frequency + duration counters, gated by `DSPEC_TRACE_RENDERS` so prod paths stay free. */
...
const enabled = ((): boolean => {
  const v = process.env.DSPEC_TRACE_RENDERS;
...
/** True when `DSPEC_TRACE_RENDERS` is set — skip expensive wiring otherwise. */
