...
const INIT_PROMPT = [
  ...
  "5. Write DSPEC.md with the sections below, skipping any you can't",
  "   fill from evidence.",
  "",
  ...
  "## Output",
  "",
  "Write the result to `DSPEC.md` in the project root using the",
...
const init: SlashHandler = (args, _loop, ctx) => {
  ...
  const target = pathMod.join(ctx.codeRoot, "DSPEC.md");
