...
export const ru: TranslationSchema = {
  ...
  themePicker: {
    ...
    autoDesc: "использовать DSPEC_THEME или по умолчанию",
  },
  planFlow: {
    ...EN.planFlow,
  ...
  scheduler: {
    ...
    historyStatusError: "✗",
    addUsage: "Использование: /schedule add <имя> --cron <выражение> <запрос>",
    addCreated: "Задача '{name}' создана ({id}) — {description}",
    addCronInvalid:
      "Неверное cron-выражение: {reason}. Ожидается 5 полей (мин час день месяц день_нед).",
    addCronDescription: "Расписание: {description}",
    listEmpty: "Нет запланированных задач. Используйте /schedule add для создания.",
    listHeader: "{name}  {cron}  {description}  {enabled}  {nextRun}  {lastRun}",
    listRow: "{name}  {cron}  {description}  {enabled}  {nextRun}  {lastRun}",
    listEnabled: "вкл",
    listDisabled: "выкл",
    removeUsage: "Использование: /schedule remove <имя|id>",
    removeNotFound: "Задача не найдена: {id}",
    removeSuccess: "Задача '{name}' удалена.",
    toggleUsage: "Использование: /schedule <enable|disable> <имя|id>",
    toggleNotFound: "Задача не найдена: {id}",
    enableSuccess: "Задача '{name}' включена.",
    disableSuccess: "Задача '{name}' отключена.",
    helpText:
      "Использование: /schedule <подкоманда>\n\nПодкоманды:\n  add <имя> --cron <выражение> <запрос>  Создать задачу\n  list                                    Список задач\n  remove <имя|id>                         Удалить задачу\n  enable <имя|id>                         Включить задачу\n  disable <имя|id>                        Отключить задачу\n  history <имя|id>                        История выполнения",
  },
};
