...
describe("handleSlash", () => {
  ...
  it("/about prints version, website, repo, and MIT license", () => {
    ...
    expect(r.info).toContain("https://esengine.github.io/DeepSeek-Spec/");
    expect(r.info).toContain("https://github.com/esengine/DeepSeek-Spec");
  ...
  it("suggestSlashCommands filters by prefix", () => {
    ...
    expect(suggestSlashCommands("HE").map((s) => s.cmd)).toEqual(["help", "theme"]);
