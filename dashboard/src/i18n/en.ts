export const en = {
  app: {
    ...
    empty: {
      ...
      welcome: "Welcome to DeepSeek-Spec",
    },
    errorLabel: "Error",
  ...
  overview: {
    ...
    standaloneDesc:
      "Read-only disk view. Start /dashboard from inside dspec code for live session state, MCP, and tools.",
    cockpit: "Cockpit",
    balance: "balance",
    tokens7d: "tokens · 7d",
    cacheHit: "cache hit",
    ...
    noSession: "No live session — /dashboard from inside dspec code to attach.",
  ...
  usage: {
    ...
    noData: "No usage data yet — run a turn in dspec chat / code / run and refresh.",
  ...
  sessions: {
    ...
    attachRequired:
      "Live session operations need an attached CLI session. Launch via dspec chat or open the dashboard from inside a TUI session.",
    activeChip: "active",
    activePill: "active",
  },
  tools: {
  ...
  permissions: {
    ...
    standaloneWarning:
      "Mutations require /dashboard from inside an active dspec code session — standalone dspec dashboard can't tell which project's allowlist to edit.",
  },
  mcp: {
    loading: "loading MCP…",
    ...
    saved: "saved",
    savedRestart: "saved — restart dspec code to bridge this server",
    ...
    whyUnbridgedDesc:
      "This spec lives in your config.json but isn't bridged into the live session. MCP servers attach when dspec code starts; the dashboard alone can't spawn the child process.",
    whyUnbridgedHint: "To activate: restart dspec code, then refresh this dashboard.",
    bridgeFailed: "Bridge failed",
    bridgeFailedTitle: "bridge failed · in config",
    bridgeFailedHint:
      "DeepSeek-Spec tried to bridge this server and the attempt errored. Common causes: wrong URL, missing auth header, upstream 404/5xx, missing local command. Fix and restart dspec code to retry.",
    ...
    marketplaceEnvHint:
      "Set these in your shell before next `dspec code` so the bridged server can authenticate.",
    marketplaceRestartHint:
      "Spec written to ~/.dspec/config.json. Restart `dspec code` to bridge the server (live hot-reload is on the roadmap).",
  },
  memory: {
    ...
    pickDesc: "Project DSPEC.md is committable; global notes live in ~/.dspec/memory/.",
    chars: "{count} chars",
    saved: "saved {scope}",
  ...
  hooks: {
    ...
    colScript: "script",
    noProject: "No active project — open /dashboard from dspec code to edit project hooks.",
  ...
  skills: {
    ...
    builtinDesc:
      "Built-in skills ship with DeepSeek-Spec; the model picks them up automatically. To customize, create a project- or global-scoped skill with the same name.",
  ...
  system: {
    ...
    built: "● built",
    none: "— none",
    runIndex: "run dspec index to build",
    usageLog: "usage log",
  ...
  semantic: {
    ...
    installOllamaDesc:
      "DeepSeek-Spec doesn't run package managers for you. Install Ollama first, then come back:",
    ...
    apiUrl: "API URL",
    apiKey: "API key",
    apiKeyStoredNote: "API key is stored in ~/.dspec/config.json — do not share that file.",
    ...
    remoteProviderDesc:
      "Configure the full OpenAI-compatible embeddings URL here. DeepSeek-Spec will send requests exactly to the URL you provide.",
    ollama: "ollama",
    binary: "binary",
    found: "found",
    missing: "missing",
